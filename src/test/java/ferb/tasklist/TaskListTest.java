...
public class TaskListTest {
    ...
    public void sortDescription_sortsTasksByDescription() throws FerbException {
        ...
        assertEquals("Buy groceries", taskList.get(0).taskDescription());
        assertEquals("Read a book", taskList.get(1).taskDescription());
        assertEquals("Submit assignment", taskList.get(2).taskDescription());
    }
    ...
    public void sortDate_sortsTasksByDate() throws FerbException{
        ...
        assertEquals("Project deadline", taskList.get(0).taskDescription());
        assertEquals("Conference", taskList.get(1).taskDescription());
        assertEquals("Submit assignment", taskList.get(2).taskDescription());
    }
}